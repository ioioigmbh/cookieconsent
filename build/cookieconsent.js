      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          button.addEventListener('click', function () {
            ...
            setTimeout(function () {
              _this.render('bar', _this.buildBar(), function (bar) {
                // Show the bar after a while
                bar.classList.remove('ccb--hidden');
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          _button.addEventListener('click', function () {
            ...
            for (var key in window.CookieConsent.config.categories) {
              window.CookieConsent.config.categories[key].wanted = window.CookieConsent.config.categories[key].checked = window.CookieConsent.config.categories[key].needed ? true : false;
            }
...
var Configuration = /*#__PURE__*/function () {
  function Configuration(configObject) {
    ...
    window.CookieConsent.config = {
      ...
      barTimeout: 1000,
      theme: {
        backgroundColor: 'rgba(44, 124, 191, .5)',
        barColor: '#2C7CBF',
        barTextColor: '#FFF',
        barMainButtonColor: '#0F0',
        barSecondaryButtonColor: '#FFF',
        barMainButtonTextColor: '#FFF',
        barSecondaryButtonTextColor: '#2C7CBF',
      ...
      language: {
        ...
        locale: {
          en: {
            ...
            barBtnRejectAll: 'Don\'t allow cookies.',
          ...
          de: {
            ...
            barBtnRejectAll: 'Keine Cookies zulassen',
