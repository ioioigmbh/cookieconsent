...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=o(require("./Utilities"));function o(e){return e&&e.__esModule?e:{default:e}}function n(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}function i(e,o){for(var n=0;n<o.length;n++){var i=o[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function t(e,o,n){return o&&i(e.prototype,o),n&&i(e,n),e}var c=function(){function o(){n(this,o)}return t(o,[{key:"init",value:function(){this.removeUnwantedCookies()}},{key:"removeUnwantedCookies",value:function(){var o=[];for(var n in document.cookie.split(";").map(function(e){o.push(e.split("=")[0].replace(/(^\s*)|(\s*&)/,""))}),window.CookieConsent.config.services)if("Array"===e.default.objectType(window.CookieConsent.config.services[n].cookies)&&!window.CookieConsent.config.categories[window.CookieConsent.config.services[n].category].wanted)for(var i in window.CookieConsent.config.services[n].cookies){var t=e.default.objectType(window.CookieConsent.config.services[n].cookies[i]);if("String"===t)o.indexOf(window.CookieConsent.config.services[n].cookies[i])>-1&&this.removeCookie(window.CookieConsent.config.services[n].cookies[i]);else if("RegExp"===t)for(var c in o)o[c].match(window.CookieConsent.config.services[n].cookies[i])&&this.removeCookie(o[c])}}},{key:"removeCookie",value:function(e){document.cookie="".concat(e,"=; expires=Thu, 01 Jan 1980 00:00:00 UTC; domain=").concat(window.location.hostname,"; path=/;"),document.cookie="".concat(e,"=; expires=Thu, 01 Jan 1980 00:00:00 UTC; domain=.").concat(window.location.hostname,"; path=/;")}}]),o}();exports.default=c;
